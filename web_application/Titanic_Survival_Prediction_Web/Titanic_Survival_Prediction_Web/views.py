...
def getPredictions(pclass, sex, age, sibsp, parch, fare, C, Q, S):
    import pickle
    model = pickle.load(open("Titanic_Survival_Prediction_Web/titanic_survival_ml_model.sav", "rb"))
    scaled = pickle.load(open("Titanic_Survival_Prediction_Web/scaler.sav", "rb"))
